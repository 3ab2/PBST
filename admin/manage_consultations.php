...
<button class="breadcrumb-header" data-bs-toggle="modal" data-bs-target="#addConsultationModal"><?php echo htmlspecialchars($translations['add_consultation'] ?? 'إضافة استشارة'); ?></button>
</div>
